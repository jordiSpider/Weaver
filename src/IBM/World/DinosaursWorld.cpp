...
double DinosaursWorld::calculateTotalMetabolicDryMassLoss(const double &wetMass, const double &proportionOfTimeTheAnimalWasMoving, const Animal* const animal) const
{
    ...
    double basalMetabolicTax = 0.002*pow(wetMass*1000,animal->getTrait(Trait::Type::met_rate));
    
    double distanceMoved = proportionOfTimeTheAnimalWasMoving*animal->getTrait(Trait::Type::search_area);
...
const DinosaursWorld::Type DinosaursWorld::getWorldType() const
{
    return DinosaursWorld::Type::Dinosaurs;
}
...
// Specialisation
template void DinosaursWorld::serialize<boost::archive::text_iarchive>(boost::archive::text_iarchive&, const unsigned int);
template void DinosaursWorld::serialize<boost::archive::text_oarchive>(boost::archive::text_oarchive&, const unsigned int);

template void DinosaursWorld::serialize<boost::archive::binary_iarchive>(boost::archive::binary_iarchive&, const unsigned int);
template void DinosaursWorld::serialize<boost::archive::binary_oarchive>(boost::archive::binary_oarchive&, const unsigned int);

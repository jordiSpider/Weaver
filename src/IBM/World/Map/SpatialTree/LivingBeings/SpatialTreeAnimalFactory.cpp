...
AnimalInterface* SpatialTreeAnimalFactory::createInstance(Gamete* const firstParentGamete, Gamete* const secondParentGamete, TerrainCellInterface* parentTerrainCellInterface, double factorEggMassFromMom, double timeStep, int g_numb_prt1,
		int g_numb_prt2, int ID_prt1, int ID_prt2, AnimalSpecies* const mySpecies, AnimalSpecies::Gender::GenderValue gender,
		bool temporary)
{
    switch(AnimalFactory::Type::Default) {
		case AnimalFactory::Type::Default: {
			return new SpatialTreeAnimal(firstParentGamete, secondParentGamete, parentTerrainCellInterface, factorEggMassFromMom, timeStep, g_numb_prt1, g_numb_prt2, ID_prt1, ID_prt2, mySpecies, gender, temporary);
			break;
		}
		default: {
			throwLineInfoException("Default case");

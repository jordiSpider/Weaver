...
const double& GrowthCurveParams::getGrowthCoefficient() const
{
	return growthCoefficient;
}

const double& GrowthCurveParams::getTime() const
{
	return time;
}

void GrowthCurveParams::setGrowthCoefficient(const double &growthCoefficient)
{
	this->growthCoefficient = growthCoefficient;
}

void GrowthCurveParams::setTime(const double &time)
{
	this->time = time;
}
...
GrowthCurveType::CurveTypeValue VonBertalanffyCurve::getType() const
{
	return GrowthCurveType::VonBertalanffy;
}
...
GrowthCurveType::CurveTypeValue LogisticCurve::getType() const
{
	return GrowthCurveType::Logistic;
}
...
GrowthCurveType::CurveTypeValue Logistic3PCurve::getType() const
{
	return GrowthCurveType::Logistic3P;
}
...
GrowthCurveType::CurveTypeValue Logistic4PCurve::getType() const
{
	return GrowthCurveType::Logistic4P;
}
...
GrowthCurveType::CurveTypeValue GompertzCurve::getType() const
{
	return GrowthCurveType::Gompertz;
}
...
GrowthCurveType::CurveTypeValue ExponentialCurve::getType() const
{
	return GrowthCurveType::Exponential;
}

...
json.traits.base.assim.limits.min = 0.005061728  # Lower limit on assimilation rate
...
json.traits.base.eggDevTime.limits.min = 0.005  # Min for individual egg development time

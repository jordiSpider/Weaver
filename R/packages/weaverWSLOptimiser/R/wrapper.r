...
generateRunParams <- function() {
    ...
    weaverWSLRootPath <- "/mnt/c/Users/mcs20/Desktop/EEZA/Weaver"
...
executeOptimiser <- function(run_params_path, overwrite) {
    args <- c("-d", "Ubuntu-22.04", "/mnt/c/Users/mcs20/Desktop/EEZA/Weaver/optimiser.out", "--run_params_path", run_params_path)

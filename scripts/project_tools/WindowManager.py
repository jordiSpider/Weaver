...
class WindowManager:
    ...
    ## @brief Displays the selected action
    #
    # @param action_name Name of action
    def show_action_selected(self, action_name: str):
        self._stdscr.addstr("> Action selected: ", curses.color_pair(self._colors.NORMAL))
        self._stdscr.addstr(f'"{self._tools.config["actions"][action_name]["description"]}"', curses.A_BOLD)
        self._stdscr.addstr(" [", curses.color_pair(self._colors.NORMAL))

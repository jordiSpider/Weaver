...
#include "World/LivingBeings/Animals/Genetics/Gamete.h"
...
#include "World/LivingBeings/Resources/Resource.h"
...
public:
	...
	explicit Animal(Gamete* const firstParentGamete, Gamete* const secondParentGamete, double newFactorEggMassFromMom, double timeStep, int g_numb_prt1,
			int g_numb_prt2, int ID_prt1, int ID_prt2, AnimalSpecies* const mySpecies, AnimalSpecies::Gender::GenderValue gender,
			bool temporary=false);
	/**
	...
	virtual AnimalSpecies::Gender::GenderValue getGender() const { return gender; };
...
protected:
	...
	const std::vector<TraitType>* const variableTraits;
	//double vonBertK;
 ...
 */	double currentBodySize;
	...
	virtual AnimalInterface* createOffspring(Gamete* const firstParentGamete, Gamete* const secondParentGamete, double eggMassAtBirth, double timeStep, int g_numb_prt1,
			int g_numb_prt2, int ID_prt1, int ID_prt2, AnimalSpecies* const mySpecies, AnimalSpecies::Gender::GenderValue gender,

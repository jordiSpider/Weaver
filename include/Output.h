...
public:
    static std::FILE* const nullFile;
    ...
    static void cout(const std::string& message, Args&&... args)
    {
        fmt::print(output, message, args...);
    }
    template <typename... Args>
    static void coutFlush(const std::string& message, Args&&... args)
    {
        fmt::print(output, message, args...);
        fflush(output);
    }
    template <typename... Args>
    static void cerr(const std::string& message, Args&&... args)
    {
        fmt::print(errorOutput, message, args...);
    }
    template <typename... Args>
    static void print(std::FILE* file, const std::string& message, Args&&... args)
    {
        fmt::print(file, message, args...);
    }
};

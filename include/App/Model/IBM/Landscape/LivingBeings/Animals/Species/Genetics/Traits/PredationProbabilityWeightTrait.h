/**
 * @file PredationProbabilityWeightTrait.h
 * @brief Defines the PredationProbabilityWeightTrait class, representing traits that affect predation probability decisions in animals.
 */

#ifndef PREDATION_PROBABILITY_WEIGHT_TRAIT_H_
#define PREDATION_PROBABILITY_WEIGHT_TRAIT_H_
...
/**
 * @class PredationProbabilityWeightTrait
 * @brief Represents a trait that influences predation probability for behavioral decisions in animal species.
 *
 ...
 */
class PredationProbabilityWeightTrait : public DecisionsTrait {
public:
    /**
     * @brief Generate a vector of PredationProbabilityWeightTrait objects.
    ...
    PredationProbabilityWeightTrait();

    /**
     * @brief Constructor with type and configuration.
     * @param individualLevelTraits Vector of individual-level traits.
     * @param type Type of PredationProbabilityWeightTrait.
     * @param config JSON configuration.
     * @param individualLevelTraitsOrder Order of individual-level traits.
     */
    PredationProbabilityWeightTrait(std::vector<IndividualLevelTrait*>& individualLevelTraits, const PredationProbabilityWeightType type, const nlohmann::json& config, const std::vector<nlohmann::json>& individualLevelTraitsOrder);
    
    /** @brief Destructor. */
    virtual ~PredationProbabilityWeightTrait();
...
#endif // PREDATION_PROBABILITY_WEIGHT_TRAIT_H_

...
private:
    ...
    public:
        ...
        inline static const TypeElemJSONValue stringToEnumValue(const std::string &str) { 
			...
			{
				throwLineInfoException("': Unknown elem type '" + str + "'. Valid values are " + std::string(printAvailableValues()));
			}
        }
    ...
    public:
        ...
        inline static const OperatorJSONType stringToEnumValue(const std::string &str) { 
			...
			{
				throwLineInfoException("': Unknown operator type '" + str + "'. Valid values are " + std::string(printAvailableValues()));
			}
        }
    ...
    public:
        ...
        inline static const ItemsOrderType stringToEnumValue(const std::string &str) { 
			...
			{
				throwLineInfoException("': Unknown item order type '" + str + "'. Valid values are " + std::string(printAvailableValues()));
			}
        }
    ...
    public:
        ...
        inline static const EnvironmentType stringToEnumValue(const std::string &str) { 
			...
			{
				throwLineInfoException("': Unknown environment type '" + str + "'. Valid values are " + std::string(printAvailableValues()));
			} 
        }
    ...
    static void addNullProperty(nlohmann::json& properties, const nlohmann::json& nullPropertyToAdd, const std::string patternElem = "");
    ...
    static void removeNullProperty(nlohmann::json& properties, const nlohmann::json& nullPropertyToRemove, const std::string patternElem = "");

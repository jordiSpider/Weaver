...
std::string createOutputFile(OutputFileStream &file, boost::filesystem::path filenameRoot, std::string filename, std::string extension, std::ios_base::openmode openMode = std::ofstream::out);
std::string createOutputFile(OutputFileStream &file, boost::filesystem::path filenameRoot, std::string filename, std::string extension, date_type timeStep, unsigned int recordEach, std::ios_base::openmode openMode = std::ofstream::out);

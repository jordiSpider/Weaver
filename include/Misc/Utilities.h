...
std::string createOutputFile(std::ofstream &file, boost::filesystem::path filenameRoot, std::string filename, std::string extension, const unsigned int numberOfTimeSteps, unsigned int recordEach, std::ios_base::openmode openMode = std::ofstream::out);

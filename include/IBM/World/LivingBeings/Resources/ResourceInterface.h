...
public:
	...
	static std::unique_ptr<ResourceInterface> createInstance(const MapInterface& mapInterface, 
		TerrainCellInterface* const terrainCellInterface
	);


	ResourceInterface(TerrainCellInterface* terrainCellInterface);
...
namespace boost {
    namespace serialization {
        template<class Archive>
        void serialize(
            Archive &ar, ResourceInterface* &resourceInterfacePtr, const unsigned int version, 

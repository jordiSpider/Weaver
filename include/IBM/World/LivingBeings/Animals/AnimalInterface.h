...
public:
	AnimalInterface(TerrainCellInterface* const terrainCellInterface);
	AnimalInterface(Species* const mySpecies, const Instar &instar, const bool temporary);
	AnimalInterface(Species* const mySpecies, const Instar &instar, const bool temporary, TerrainCellInterface* parentTerrainCellInterface);
	...
	virtual AnimalSpecies::Gender getGender() const=0;
...
namespace boost {
    namespace serialization {
        template<class Archive>
        void serialize(
            Archive &ar, AnimalInterface* &animalInterfacePtr, const unsigned int version, 

...
protected:
    ...
    std::vector<unsigned int> axisSizes;
    unsigned int totalNumberOfTerrainCells;
    RootTerrainCell* rootTerrainCell;

    std::pair<std::unique_ptr<std::vector<std::vector<std::vector<TerrainCellInterface *>::iterator>>>, std::unique_ptr<std::vector<std::vector<std::vector<TerrainCellInterface *>::iterator>>>> obtainLeafAndBranchInhabitableTerrainCells(std::vector<TerrainCellInterface*>& inhabitableTerrainCells);
...
public:
    ...
    SpatialTree(WorldInterface* const worldInterface);
    virtual ~SpatialTree();
     ...
     * @{
     */
    bool applyMoisturePatch(MoisturePatch &moisturePatch);
    /** @} */
    ...
    std::unique_ptr<std::vector<TerrainCellInterface*>> obtainInhabitableTerrainCells() const;
    std::unique_ptr<std::vector<CustomIndexedVector<Instar, std::vector<std::vector<TerrainCellInterface*>::iterator>>>> obtainSpeciesInhabitableTerrainCells(std::vector<TerrainCellInterface*>& inhabitableTerrainCells);
    std::pair<std::unique_ptr<std::vector<CustomIndexedVector<Instar, std::vector<AnimalInterface*>>>>, unsigned int> generateStatisticsPopulation(std::vector<CustomIndexedVector<Instar, std::vector<std::vector<TerrainCellInterface*>::iterator>>> &mapSpeciesInhabitableTerrainCells);
    const int generatePopulation(AnimalSpecies* currentAnimalSpecies, const CustomIndexedVector<Instar, std::vector<std::vector<TerrainCellInterface*>::iterator>> &speciesInhabitableTerrainCells);
    ...
    void obtainWorldResourceBiomassAndAnimalsPopulation(std::vector<double> &worldResourceBiomass, CustomIndexedVector<AnimalSpecies::AnimalID, CustomIndexedVector<LifeStage, unsigned int>> &worldAnimalsPopulation) const;
    void obtainAnimalsPopulationAndGeneticsFrequencies(CustomIndexedVector<AnimalSpecies::AnimalID, CustomIndexedVector<LifeStage, unsigned int>> &worldAnimalsPopulation, std::vector<std::vector<std::pair<std::vector<double>, std::vector<double>>>> &worldGeneticsFrequencies) const;

...
protected:
    ...
    const PointContinuous* const& getCenter() const;
    ...
    void setResource(const unsigned int resourceSpeciesId, ResourceInterface* &newResource); //?
    /** @} */
     ...
     * @{
     */
    LifeStageVector* animals; // Stores all the animals living within this cell
    /** @} */
    ...
    virtual std::pair<bool, bool> applyMoisturePatch(MoisturePatch &moisturePatch)=0; //?
    ...
    virtual void setMoistureSourcePatch(MoisturePatch &moisturePatch); //?
    ...
    virtual void setResourceSourcePatch(ResourceInterface* &newResource, const int newResourcePatchPriority); //?
    virtual void setResourcePatch(const unsigned int resourceSpeciesId, ResourceInterface* &newResource, const int newResourcePatchPriority); //?
    /** @} */
...
public:
    TerrainCell(MapInterface* const mapInterface);
    ...
    void addAnimal(const LifeStage &lifeStage, const unsigned int animalSpeciesId, const Instar &instar, const AnimalSpecies::Gender &gender, AnimalInterface* const newAnimal);
    void eraseAnimal(AnimalInterface* const animalToRemove);
    void eraseAnimal(const LifeStage &lifeStage, const unsigned int animalSpeciesId, const Instar &instar, const AnimalSpecies::Gender &gender, AnimalInterface* const animalToRemove);
    void eraseAllAnimals();
    void purgeDeadAnimals();

    const double& getTotalMaximumResourceCapacity() const;

    virtual void obtainInhabitableTerrainCells(std::vector<TerrainCellInterface*>& inhabitableTerrainCells);
    ...
    const std::vector<ResourceInterface*>& getResources() const;
     ...
     * @{
     */
    std::pair<bool, bool> checkMoisturePatch(MoisturePatch &moisturePatch); //?
    ...
    virtual void obtainWorldAnimalsPopulation(CustomIndexedVector<AnimalSpecies::AnimalID, CustomIndexedVector<LifeStage, unsigned int>> &worldAnimalsPopulation);
    virtual void obtainAnimalsPopulationAndGeneticsFrequencies(CustomIndexedVector<AnimalSpecies::AnimalID, CustomIndexedVector<LifeStage, unsigned int>> &worldAnimalsPopulation, std::vector<std::vector<std::pair<std::vector<double>, std::vector<double>>>> &worldGeneticsFrequencies);

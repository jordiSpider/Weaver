...
typedef CustomIndexedVector<AnimalSpecies::Gender, AnimalVector> GenderVector;
typedef CustomIndexedVector<Instar, GenderVector> InstarVector;
typedef CustomIndexedVector<AnimalSpecies::AnimalID, InstarVector> AnimalSpeciesVector;
typedef CustomIndexedVector<LifeStage, AnimalSpeciesVector> LifeStageVector;

typedef std::vector<ResourceInterface*> ResourceSpeciesVector;
...
protected:
    ...
    virtual const PointContinuous* const& getCenter() const=0;
...
public:
    ...
    virtual void addAnimal(const LifeStage &lifeStage, const unsigned int animalSpeciesId, const Instar &instar, const AnimalSpecies::Gender &gender, AnimalInterface* const newAnimal)=0;
    virtual void eraseAnimal(AnimalInterface* const animalToRemove)=0;
    virtual void eraseAnimal(const LifeStage &lifeStage, const unsigned int animalSpeciesId, const Instar &instar, const AnimalSpecies::Gender &gender, AnimalInterface* const animalToRemove)=0;
    ...
    virtual const std::vector<ResourceInterface*>& getResources() const=0;
    ...
    virtual void obtainInhabitableTerrainCells(std::vector<TerrainCellInterface*>& inhabitableTerrainCells)=0;
